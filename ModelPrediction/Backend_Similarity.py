...
def check_similarity(lyrics_testing):
...
async def check_similarity_api(lyrics: str = Form(None), audio_file: UploadFile = None):
    try:
        if audio_file:
            ...
            df_result = check_similarity(lyrics_processed)
