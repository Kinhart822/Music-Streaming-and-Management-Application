document.addEventListener('DOMContentLoaded', () => {
    ...
    const renderTable = () => {
        ...
        userTableBody.innerHTML = paginatedUsers.length > 0
            ...
            : '<tr><td colspan="5"><span class="no-users">No users found.</span></td></tr>';
    ...
    userForm.addEventListener('submit', (e) => {
        ...
        if (isValid) {
            ...
            addUserForm.classList.remove('active');
            renderTable();
            alert(`User "${username}" added successfully as ${roleSelect.value.charAt(0).toUpperCase() + roleSelect.value.slice(1)}.`);
        }
    });
