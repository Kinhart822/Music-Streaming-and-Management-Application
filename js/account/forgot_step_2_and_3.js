...
if (otpForm) {
    otpForm.addEventListener('submit', async (e) => {
        ...
        try {
            ...
            const response = await fetch('https://music-streaming-and-management.onrender.com/api/v1/account/user/forgot-password/check-otp', {
                method: 'POST',
                headers: {
...
if (resetForm) {
    resetForm.addEventListener('submit', async (e) => {
        ...
        try {
            ...
            const response = await fetch('https://music-streaming-and-management.onrender.com/api/v1/account/user/forgot-password/finish', {
                method: 'POST',
                headers: {
                    'Content-Type': 'application/json',
                    'Accept': 'application/json'
