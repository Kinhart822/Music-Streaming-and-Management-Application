...
const checkEmailExistence = async (email) => {
    try {
        ...
        const url = `https://music-streaming-and-management.onrender.com/api/v1/account/user/sign-up/check-email-existence?query=${encodedEmail}`;
...
signUpForm.addEventListener('submit', async (e) => {
    ...
    try {
        const response = await fetch('https://music-streaming-and-management.onrender.com/api/v1/account/signUpArtist', {
            method: 'POST',
            headers: {
                'Content-Type': 'application/json',
                'Accept': 'application/json'
...
signInForm.addEventListener('submit', async (e) => {
    ...
    try {
        ...
        const response = await fetch('https://music-streaming-and-management.onrender.com/api/v1/auth/sign-in', {
            method: 'POST',
            headers: {
                'Content-Type': 'application/json',
                'Accept': 'application/json'
