...
def log_missing_lyric(track_info):
    file_path = "../music/copyrighted/no_lyric_tracks.csv"
...
def download_track(track_info):
    ...
    try:
        ...
        destination = os.path.join("../music/copyrighted", f"{title_part}.mp3")
...
def main():
    while True:
        ...
        if "n" in user_input:
            ...
            fetch_playlist_tracks_info("https://open.spotify.com/playlist/1UvD7LWiVaKd8KYFFhsrKc")
            while True:
                tracks = fetch_playlist_tracks("https://open.spotify.com/playlist/1UvD7LWiVaKd8KYFFhsrKc")
                track_choice = input(
